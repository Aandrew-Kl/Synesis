...
const activePrograms: Program[] = [
  {
    title: "«Παράγουμε στην Ελλάδα»",
    description:
      "Επιδότηση 50-55% σε υφιστάμενες μικρές, πολύ μικρές και μεσαίες μεταποιητικές επιχειρήσεις (ίδρυση πριν 1/1/2025). Εκσυγχρονισμός παραγωγής, τεχνολογική αναβάθμιση, πιστοποιήσεις, branding και ενίσχυση ανθρώπινου δυναμικού.",
    subsidy: "50–55%",
    maxFunding: "€100.000 – €400.000",
    deadline: "31/03/2026",
    region: "Πανελλαδικά",
    icon: Factory,
  },
