...
export default function EpixeirematikaSxediaPage() {
  return (
    <main>
      <section className="bg-gradient-to-br from-[#F8F6F0] to-[#EDE9DF] px-6 py-24 text-center">
        ...
        <h2 className="mt-2 text-xl text-[#5A5A6A] sm:text-2xl">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        >
          ...
          <p className="mt-4 text-base leading-relaxed text-[#5A5A6A]">
            Αναλαμβάνουμε την εκπόνηση ολοκληρωμένων επιχειρηματικών σχεδίων και
            μελετών βιωσιμότητας για νέες και υφιστάμενες επιχειρήσεις. Η
            τεχνογνωσία μας εξασφαλίζει τεκμηριωμένα σχέδια που ανταποκρίνονται
            στις απαιτήσεις χρηματοδοτικών φορέων και τραπεζών.
          </p>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <h2 className="text-3xl font-bold text-[#0A1628] sm:text-4xl">
              Ενδιαφέρεστε για Επιχειρηματικό Σχέδιο;
            </h2>
            <div className="mx-auto mt-4 h-1 w-20 rounded-full bg-[#C8A951]" />
            <p className="mt-6 text-base leading-relaxed text-[#5A5A6A] md:text-lg">
              Επικοινωνήστε μαζί μας για εξατομικευμένη προσφορά και
              καθοδήγηση στο επιχειρηματικό σας σχέδιο.
            </p>
            <Link
              href="/contact"
