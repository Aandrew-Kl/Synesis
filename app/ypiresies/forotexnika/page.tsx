...
export default function ForotexnikaPage() {
  return (
    <main>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        >
          <Receipt size={48} className="text-[#C8A951]" />
          <h3 className="mt-6 text-2xl font-bold text-[#0A1628]">
            Φοροτεχνικές Υπηρεσίες
          </h3>
          <p className="mt-4 text-base leading-relaxed text-[#5A5A6A]">
            Παρέχουμε ολοκληρωμένη φοροτεχνική υποστήριξη, φορολογικό
            σχεδιασμό και συμμόρφωση για επιχειρήσεις και ελεύθερους
            επαγγελματίες. Στόχος μας είναι η βελτιστοποίηση της
            φορολογικής θέσης σας εντός του νομικού πλαισίου.
          </p>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <h2 className="text-3xl font-bold text-[#0A1628] sm:text-4xl">
              Χρειάζεστε Φοροτεχνική Υποστήριξη;
            </h2>
            <div className="mx-auto mt-4 h-1 w-20 rounded-full bg-[#C8A951]" />
            <p className="mt-6 text-base leading-relaxed text-[#5A5A6A] md:text-lg">
              Επικοινωνήστε μαζί μας για εξατομικευμένη φοροτεχνική
              καθοδήγηση.
            </p>
            <Link
              href="/contact"
