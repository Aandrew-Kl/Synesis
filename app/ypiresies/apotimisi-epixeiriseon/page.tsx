...
export default function ApotimisiPage() {
  return (
    <main>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        >
          <BarChart3 size={48} className="text-[#C8A951]" />
          <h3 className="mt-6 text-2xl font-bold text-[#0A1628]">
            Αποτίμηση & Συγχωνεύσεις
          </h3>
          <p className="mt-4 text-base leading-relaxed text-[#5A5A6A]">
            Παρέχουμε ολοκληρωμένες υπηρεσίες αποτίμησης αξίας επιχειρήσεων
            καθώς και συμβουλευτική υποστήριξη σε διαδικασίες συγχωνεύσεων,
            εξαγορών και αναδιαρθρώσεων. Η μεθοδολογία μας βασίζεται σε
            διεθνώς αναγνωρισμένα πρότυπα αποτίμησης.
          </p>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <h2 className="text-3xl font-bold text-[#0A1628] sm:text-4xl">
              Χρειάζεστε Αποτίμηση Επιχείρησης;
            </h2>
            <div className="mx-auto mt-4 h-1 w-20 rounded-full bg-[#C8A951]" />
            <p className="mt-6 text-base leading-relaxed text-[#5A5A6A] md:text-lg">
              Επικοινωνήστε μαζί μας για εξατομικευμένη αξιολόγηση
              και καθοδήγηση.
            </p>
            <Link
              href="/contact"
