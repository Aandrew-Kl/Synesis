  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        >
          <Calculator size={48} className="text-[#C8A951]" />
          ...
          <p className="mt-4 text-base leading-relaxed text-[#5A5A6A]">
            Αναλαμβάνουμε τη διαπραγμάτευση και ρύθμιση οφειλών μέσω του
            εξωδικαστικού μηχανισμού για επιχειρήσεις και φυσικά πρόσωπα.
            Στόχος μας είναι η εξεύρεση βιώσιμων λύσεων αποπληρωμής που
            διασφαλίζουν τη συνέχιση της επιχειρηματικής δραστηριότητας.
          </p>
